...
function Coils() {
  ...
  const CoilsCoilMidRef: RefObject<HTMLDivElement> = createRef();
  const CoilsCoilLargeRef: RefObject<HTMLDivElement> = createRef();
  const CoilsCoilSmallRef: RefObject<HTMLDivElement> = createRef();
  ...
  useEffect(() => {
    ...
    CoilsCoilMidRef.current!.setAttribute("style",`
    ...
    CoilsCoilLargeRef.current!.setAttribute("style",`
    ...
    `);
    CoilsCoilSmallRef.current!.setAttribute("style",`
